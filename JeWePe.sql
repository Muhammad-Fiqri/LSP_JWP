...
--
-- Host: localhost
-- Generation Time: May 18, 2026 at 05:00 PM
...
INSERT INTO `order` (`order_id`, `package_id`, `name`, `email`, `wedding_date`, `status`, `created_at`, `updated_at`) VALUES
(2, 3, 'Muhammad Fiqri', 'bloodcyka101@gmail.com', '2026-05-31', 'requested', '2026-05-18 21:58:31', '2026-05-18 21:58:31');
...
--
ALTER TABLE `catalogues`
  MODIFY `package_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `post`
  MODIFY `id_post` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
